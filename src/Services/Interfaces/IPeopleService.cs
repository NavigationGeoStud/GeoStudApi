...
public interface IPeopleService
{
    ...
    Task<PagedResponse<UserProfileWithLocationsResponse>> SearchPeopleAsync(long telegramId, string? searchBy = null, int page = 1, int pageSize = 20);
    ...
    Task<PagedResponse<UserProfileWithLocationsResponse>> SearchAllPeopleAsync(long telegramId, int page = 1, int pageSize = 20);
